# Collector for EconAI Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-econai/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-econai/actions/workflows/run-python-tests.yaml)
[![Coverage Status](https://coveralls.io/repos/github/OCHA-DAP/hdx-scraper-econai/badge.svg?branch=main&ts=1)](https://coveralls.io/github/OCHA-DAP/hdx-scraper-econai?branch=main)
 ...
 **hdx-scraper-econai** as specified in the parameter
 *user_agent_lookup*.
